# Introduction to Linux for Bioinformatics L0

---
Trainer: [Ouso](https://github.com/ousodaniel)
## Course Overview
...
- <details>
    <summary>
        Click to toggle contents of <b style='color:blue'>Path shorthands</b>
    </summary>
    <ul>
        <li><b>Home directory</b>: <code>~</code> (tilde)</li>
        <li><b>Parent directory</b>: <code>..</code> (double fullstop)</li>
        <li><b>Current directory</b>: <code>.</code> (single fullstop)</li>
        <li><b>Previous directory</b>: <code>-</code> (hyphen)</li>
    </ul>
